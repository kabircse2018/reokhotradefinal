...
<div class="section section-contents section-pad" style="background: #0f4085;">
    <div class="container">
        ...
        <div class="row section-pad-f">
            <h3 class="color-white center mt-2"><strong>私たちのスマートなアプローチ</strong></h3>
